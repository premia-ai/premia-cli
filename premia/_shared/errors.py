...
class MissingApiKeyError(ConfigError):
    def __init__(self, provider: str, message: str | None = None):
        ...
        self.message = (
            message or f"{provider.capitalize()} API-Key hasn't been added yet."
        )
        super().__init__(self.message)


class MissingProvidersError(ConfigError):
    def __init__(self, message="No data provider has been set up yet."):
...
class MissingInstrumentError(ConfigError):
    def __init__(
        ...
        self.message = (
            message or f"{instrument.capitalize()} have not been set up yet."
        )
        super().__init__(self.message)
